...
# Database: talent
# Generation Time: 2015-06-01 04:44:46 +0000
# ************************************************************
...
VALUES
	...
	(12,12,1,'(⊙o⊙)…挺好的','2015-04-28 13:16:18'),
	(13,12,1,'(⊙o⊙)…挺好的','2015-04-28 13:16:24'),
	(14,12,1,'(⊙o⊙)…挺好的','2015-04-28 13:16:40'),
	(15,5,1,'(⊙o⊙)…','2015-04-28 13:18:17');
...
VALUES
	(1,1,0,'2015-04-03 10:48:20','上海市全国大学生信息安全竞赛，旨在促进大学生对信息安全的兴趣。主办方为教育部，希望大家可以积极参赛','第七届全国大学生信息安全竞赛',5,'2015-04-08 11:00:30'),
	(2,7,0,'2015-04-03 10:49:42','2015年大夏杯，属于校级比赛，分为应用型和理论型','2015年大夏杯',4,'2015-07-09 11:00:40');
...
VALUES
	...
	(22,1,1,'2015-04-28 12:38:29'),
	(23,2,1,'2015-04-28 13:25:07'),
	(24,1,11,'2015-04-28 15:07:21'),
	(25,2,11,'2015-05-29 20:40:28');
...
VALUES
	...
	(7,11,1,' ',1,'2015-04-28 13:22:40'),
	(8,11,1,' ',-1,'2015-04-28 13:23:59');
...
VALUES
	(1,11,1,'2015-06-01 12:18:51','小明申请创建[消息通信APP]的项目。',1,21,1,1,5,5),
	(15,1,11,'2015-06-01 12:19:04','teacher1拒绝了你的创建项目请求。',2,11,1,1,5,1),
	(16,11,1,'2015-06-01 12:23:33','安晓婷申请创建[测试项目1]的项目。',1,21,1,1,15,1),
	(17,1,11,'2015-06-01 12:24:48','teacher1同意了你的创建项目请求。',1,11,1,1,15,1);
...
CREATE TABLE `news` (
  ...
  `news_show_picture` varchar(255) NOT NULL DEFAULT '' COMMENT '用于主页显示的图片',
  PRIMARY KEY (`news_id`),
...
VALUES
	(1,2,4,'2015-06-01 11:14:00',1,'智能机器人','2014-12-12 00:00:00','2015-02-16 00:00:00',1,2,'软件工程','未受资助','很多事情可以通过机器人来做，解放人工。','会说话的机器人','会说话','需求文档v0.1','软件开发','8000','机器人所需材料','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','致力于智能机器人的研发',2,'本科生',0,0),
	...
	(5,1,5,'2015-06-01 12:18:51',5,'在线支付系统','2015-04-20 01:49:19','2015-04-20 01:49:23',2,1,'通信工程','阿里巴巴资助','出门忘记带钱包，手机一键支付。','一键网上支付，轻松+愉快~','扫一扫支付','代码v1.0','产品研制','9000','手机',NULL,NULL,NULL,'summary一键支付',5,'本科生',0,0),
	...
	(14,4,7,'2015-05-29 19:42:59',1,'test1','2015-05-05 00:00:00','2015-05-13 00:00:00',NULL,NULL,'','',NULL,'undefined',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',2,'',2,0),
	(15,2,3,'2015-06-01 12:23:33',1,'测试项目1','2015-05-01 08:00:00','2015-06-01 08:00:00',NULL,1,'','1','打发打发','点点滴滴','的点点滴滴','的点点滴滴','点点滴滴飞蛾','的点点滴滴','点点滴滴的额',NULL,NULL,NULL,'',0,'',0,0);
...
VALUES
	...
	(35,12,1,0,'',NULL,1,'undefined'),
	(36,15,11,2,'指导老师',NULL,0,NULL),
	(37,15,1,1,'队长',NULL,0,NULL),
	(38,15,2,3,'队员',NULL,0,NULL);
...
VALUES
	(1,1,1,1,1,'1','axt','anxiaoting','10112510218','2011','218','xxx','xxx','xxx','xxx','218@ecnu.edu.cn','xxx','xxx','18888888218','xxx','e5e4931b5275e824d28aaf61020990fffdf5746f',0,NULL),
	(2,1,1,1,1,'zy','zy','zhouyue','10112510220','2011','220','','','','','220@ecnu.edu.cn','','','18888888220','','',0,NULL),
	...
	(5,1,1,1,1,'syy','syy','songyuyi','10112510202','2011','202','','','','','202@ecnu.edu.cn','','','18888888202','','701ed035e9c8d7108c716363357be5a5cf6a07a8',0,NULL),
	(6,1,1,1,1,'lsy','lsy','liushiyang','10112510203','2011','203','','','','','203@ecnu.edu.cn','','','18888888203','','',0,NULL),
	(7,1,1,1,1,'df399330d331a0c6a2f8e1056a9eeb66ea904027','shy','shyfull','10132510262','2013','222','','','','','333','','','444','555','7',0,NULL),
	...
	(11,3,1,1,1,'teacher1','teacher1','teacher1','','2000','','教授','','','','teacher1@ecnu.edu.cn','','','','','cbd403ee8b4450dcb4193bc904383fb699d680bd',0,NULL),
	...
	(21,3,1,1,1,'admin1','admin1','admin1','','1952','','科创中心管理员','','','','','','','','','a8513710b0453e37987e05d76012efbefbccdb2a',0,NULL);
